...
public class ProfesionistasConnectedAdapter extends FirebaseRecyclerAdapter<HistoryBooking, ProfesionistasConnectedAdapter.ViewHolder> {

    private ProfesionistaProvider mProfesionistProvider;
    private Context mContext;

    public ProfesionistasConnectedAdapter(FirebaseRecyclerOptions<HistoryBooking> options, Context context) {
        super(options);
    ...
    @Override
    protected void onBindViewHolder(@NonNull HistoryBookingClientAdapter.ViewHolder holder, int position, @NonNull HistoryBooking model) {
