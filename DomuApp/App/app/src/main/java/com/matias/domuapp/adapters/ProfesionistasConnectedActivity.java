...
public class ProfesionistasConnectedActivity extends FirebaseRecyclerAdapter<HistoryBooking, HistoryBookingClientAdapter.ViewHolder> {

    private ProfesionistaProvider mProfesionistProvider;
    private Context mContext;

    public ProfesionistasConnectedActivity(FirebaseRecyclerOptions<HistoryBooking> options, Context context) {
        super(options);
